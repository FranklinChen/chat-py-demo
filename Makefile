...
$(GENERATED_PYDANTIC_CODE):	$(GENERATED_JSON_SCHEMA)
	datamodel-codegen --output-model-type pydantic_v2.BaseModel --input-file-type jsonschema --input $^ --output $@ --use-schema-description --use-annotated --use-generic-container-types --use-standard-collections --use-subclass-enum --use-union-operator --use-unique-items-as-set --enum-field-as-literal all --strip-default-none --disable-timestamp --target-python-version 3.12 --use-field-description
